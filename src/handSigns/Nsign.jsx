...
nSign.addDirection(Finger.Thumb, FingerDirection.DiagonalUpLeft, 0.70);
nSign.addDirection(Finger.Thumb, FingerDirection.DiagonalUpRight, 0.70);

//Index
nSign.addCurl(Finger.Index, FingerCurl.FullCurl, 1);
nSign.addDirection(Finger.Index, FingerDirection.VerticalUp, 0.70);
...
nSign.addDirection(Finger.Pinky, FingerDirection.VerticalUp, 0.70);
