...
vSign.addDirection(Finger.Thumb, FingerDirection.DiagonalUpRight, 0.70);
...
vSign.addDirection(Finger.Middle, FingerDirection.DiagonalUpLeft, 0.70);
vSign.addDirection(Finger.Middle, FingerDirection.DiagonalUpRight, 0.70);
...
vSign.addDirection(Finger.Pinky, FingerDirection.DiagonalDownLeft, 0.70);
vSign.addDirection(Finger.Pinky, FingerDirection.DiagonalDownRight, 0.70);
