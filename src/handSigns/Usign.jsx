...
uSign.addDirection(Finger.Thumb, FingerDirection.DiagonalUpLeft, 0.70);
uSign.addDirection(Finger.Thumb, FingerDirection.DiagonalUpRight, 0.70);
...
uSign.addDirection(Finger.Pinky, FingerDirection.DiagonalDownLeft, 0.70);
uSign.addDirection(Finger.Pinky, FingerDirection.DiagonalDownRight, 0.70);
